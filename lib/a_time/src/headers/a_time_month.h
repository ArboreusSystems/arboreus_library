...
#define A_MONTH_INT_JANUARY 1
#define A_MONTH_INT_FEBRUARY 2
#define A_MONTH_INT_MARCH 3
#define A_MONTH_INT_APRIL 4
#define A_MONTH_INT_MAY 5
#define A_MONTH_INT_JUNE 6
#define A_MONTH_INT_JULY 7
#define A_MONTH_INT_AUGUST 8
#define A_MONTH_INT_SEPTEMBER 9
#define A_MONTH_INT_OCTOBER 10
#define A_MONTH_INT_NOVEMBER 11
#define A_MONTH_INT_DECEMBER 12
