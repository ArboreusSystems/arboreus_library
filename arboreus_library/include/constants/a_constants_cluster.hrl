...
%%%
%%% @end
%%% Created : 29. Oct 2024 14:01
%%%-------------------------------------------------------------------
-author("Alexandr Kirilov, https://alexandr.kirilov.me").


-ifndef(A_CONSTANTS_CLUSTER).
-define(A_CONSTANTS_CLUSTER, 1).
...
-define(A_ID_CLUSTER_CONNECTOR_HANDLER,a_id_cluster_connector_handler).

-endif. %% A_CONSTANTS_CLUSTER