...
%% State
-record(a_cluster_controller_monitor_gs_state, {}).
...
-spec start_link(STATE) -> {ok, PID} | ignore | {error, REASON}
	when
		STATE :: #a_cluster_controller_monitor_gs_state{},
		PID :: pid(),
		REASON :: term().
...
init([_STATE]) ->
	...
	{ok, #a_cluster_controller_monitor_gs_state{}}.
...
-spec handle_call(REQUEST, FROM, STATE) ->
	...
	when
		...
		REPLY :: term(),
		STATE :: #a_cluster_controller_monitor_gs_state{},
		NEW_STATE :: #a_cluster_controller_monitor_gs_state{},
		TIMEOUT :: timeout() | hibernate,
		REASON :: term().

handle_call(_REQUEST, _FROM, STATE = #a_cluster_controller_monitor_gs_state{}) ->
...
handle_cast(_REQUEST, STATE = #a_cluster_controller_monitor_gs_state{}) ->
...
handle_info(_INFO, STATE = #a_cluster_controller_monitor_gs_state{}) ->
...
terminate(_REASON, _STATE = #a_cluster_controller_monitor_gs_state{}) ->
...
code_change(_OLD_VERSION, STATE = #a_cluster_controller_monitor_gs_state{}, _EXTRA) ->
